    ...
    def _sparsecore_preprocess(
        ...
        if training:
            ...
            if changed:
                ...
                print("### new", {n: f"max_ids: {s.max_ids_per_partition} max_uinque_ids: {s.max_unique_ids_per_partition} buffer: {s.suggested_coo_buffer_size_per_device}" for n, s in stacked_table_specs.items()})
