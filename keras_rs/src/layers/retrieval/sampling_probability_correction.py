...
@keras_rs_export("keras_rs.layers.SamplingProbablityCorrection")
class SamplingProbablityCorrection(keras.layers.Layer):
    """Sampling probability correction.

    Args:
        epsilon: Small float added to sampling probability to avoid taking the
            log of zero. Defaults to 1e-3.
